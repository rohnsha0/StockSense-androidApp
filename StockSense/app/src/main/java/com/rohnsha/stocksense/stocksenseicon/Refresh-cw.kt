...
public val StockSenseIcon.`Refresh-cw`: ImageVector
    get() {
        if (`_refresh-cw` != null) {
            return `_refresh-cw`!!
        }
        `_refresh-cw` = Builder(name = "Refresh-cw", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_refresh-cw`: ImageVector? = null
