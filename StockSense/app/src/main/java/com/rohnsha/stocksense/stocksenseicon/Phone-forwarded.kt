...
public val StockSenseIcon.`Phone-forwarded`: ImageVector
    get() {
        if (`_phone-forwarded` != null) {
            return `_phone-forwarded`!!
        }
        `_phone-forwarded` = Builder(name = "Phone-forwarded", defaultWidth = 24.0.dp, defaultHeight
...
private var `_phone-forwarded`: ImageVector? = null
