...
public val StockSenseIcon.`Phone-missed`: ImageVector
    get() {
        if (`_phone-missed` != null) {
            return `_phone-missed`!!
        }
        `_phone-missed` = Builder(name = "Phone-missed", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_phone-missed`: ImageVector? = null
