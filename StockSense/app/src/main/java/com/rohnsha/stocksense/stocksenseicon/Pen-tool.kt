...
public val StockSenseIcon.`Pen-tool`: ImageVector
    get() {
        if (`_pen-tool` != null) {
            return `_pen-tool`!!
        }
        `_pen-tool` = Builder(name = "Pen-tool", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_pen-tool`: ImageVector? = null
