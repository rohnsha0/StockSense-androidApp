...
public val StockSenseIcon.`Camera-off`: ImageVector
    get() {
        if (`_camera-off` != null) {
            return `_camera-off`!!
        }
        `_camera-off` = Builder(name = "Camera-off", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_camera-off`: ImageVector? = null
