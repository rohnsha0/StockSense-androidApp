...
public val StockSenseIcon.`Phone-off`: ImageVector
    get() {
        if (`_phone-off` != null) {
            return `_phone-off`!!
        }
        `_phone-off` = Builder(name = "Phone-off", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_phone-off`: ImageVector? = null
