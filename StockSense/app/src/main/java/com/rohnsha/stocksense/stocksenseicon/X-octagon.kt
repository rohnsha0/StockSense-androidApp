...
public val StockSenseIcon.`X-octagon`: ImageVector
    get() {
        if (`_x-octagon` != null) {
            return `_x-octagon`!!
        }
        `_x-octagon` = Builder(name = "X-octagon", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_x-octagon`: ImageVector? = null
