...
public val StockSenseIcon.`Message-circle`: ImageVector
    get() {
        if (`_message-circle` != null) {
            return `_message-circle`!!
        }
        `_message-circle` = Builder(name = "Message-circle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-circle`: ImageVector? = null
