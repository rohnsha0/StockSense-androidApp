...
public val StockSenseIcon.`Volume-1`: ImageVector
    get() {
        if (`_volume-1` != null) {
            return `_volume-1`!!
        }
        `_volume-1` = Builder(name = "Volume-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_volume-1`: ImageVector? = null
